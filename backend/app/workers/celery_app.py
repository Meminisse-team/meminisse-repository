...
def _setup_worker_file_logging(**kwargs: object) -> None:
    configure_file_logging("worker")


@beat_init.connect
def _setup_beat_file_logging(**kwargs: object) -> None:
    configure_file_logging("beat")
